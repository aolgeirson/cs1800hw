...
{\color{blue}
  All of this is wrong, but the answer is $(pXp)X(qXq)$, I need another take to prove it though
$p\land q \iff \neg (\neg p \lor \neg q)$ as the preposition $p\land q \leftrightarrow \neg p \lor \neg q$ is false in all cases\\
$\neg (\neg p \lor \neg q $
