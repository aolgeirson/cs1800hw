...
\sum\limits_{k=1}^n k(k{+}1) - (n-1)((n-1) +1) = \frac{n(n{+}1)(n{+}2)}{3}$ By subsituiting the last term of the summation\\
$\left(\dfrac{n(n+1)(n+2)}{3}\right)-(n-1)((n-1)+1)=\dfrac{n(n+1)(n+2)}{3}\\
